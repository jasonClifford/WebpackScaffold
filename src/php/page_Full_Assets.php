...
<?php
/**
* Template Name: Visionary_Full_Assets
*
*/
?>
        ...
        <!-- SIDE BAR -->
          ...
          <a href="<?php echo get_permalink( $post->post_parent ); ?>/script">
            ...
            <a href="<?php echo get_permalink( $post->post_parent ); ?>/assets">
                <input type="image" id="js-mediaBtn" src="<?php echo get_template_directory_uri(); ?>/Images/svg/AssetsICN_Actv.svg" alt="Submit">
            </a>
            ...
            <div id="topBar">
                ...
                <div id="prodHome">
                    <a href="<?php echo get_permalink( $post->post_parent ); ?>">
                            <input type="image" src="<?php echo get_template_directory_uri(); ?>/Images/svg/ProjectHome.svg" alt="Home">
                    </a>
